...
type HiveParserListener interface {
	...
	// EnterReplDbPolicy is called when entering the replDbPolicy production.
	EnterReplDbPolicy(c *ReplDbPolicyContext)
	...
	// EnterReplTableLevelPolicy is called when entering the replTableLevelPolicy production.
	EnterReplTableLevelPolicy(c *ReplTableLevelPolicyContext)
	...
	// EnterDbManagedLocation is called when entering the dbManagedLocation production.
	EnterDbManagedLocation(c *DbManagedLocationContext)
	...
	// EnterDbConnectorName is called when entering the dbConnectorName production.
	EnterDbConnectorName(c *DbConnectorNameContext)
	...
	// EnterDb_schema is called when entering the db_schema production.
	EnterDb_schema(c *Db_schemaContext)

	// EnterShowStatement is called when entering the showStatement production.
	EnterShowStatement(c *ShowStatementContext)

	// EnterShowTablesFilterExpr is called when entering the showTablesFilterExpr production.
	EnterShowTablesFilterExpr(c *ShowTablesFilterExprContext)
	...
	// EnterReloadFunctionsStatement is called when entering the reloadFunctionsStatement production.
	EnterReloadFunctionsStatement(c *ReloadFunctionsStatementContext)
	...
	// EnterViewOrganization is called when entering the viewOrganization production.
	EnterViewOrganization(c *ViewOrganizationContext)

	// EnterViewClusterSpec is called when entering the viewClusterSpec production.
	EnterViewClusterSpec(c *ViewClusterSpecContext)

	// EnterViewComplexSpec is called when entering the viewComplexSpec production.
	EnterViewComplexSpec(c *ViewComplexSpecContext)

	// EnterViewDistSpec is called when entering the viewDistSpec production.
	EnterViewDistSpec(c *ViewDistSpecContext)

	// EnterViewSortSpec is called when entering the viewSortSpec production.
	EnterViewSortSpec(c *ViewSortSpecContext)
	...
	// EnterCreateScheduledQueryStatement is called when entering the createScheduledQueryStatement production.
	EnterCreateScheduledQueryStatement(c *CreateScheduledQueryStatementContext)

	// EnterDropScheduledQueryStatement is called when entering the dropScheduledQueryStatement production.
	EnterDropScheduledQueryStatement(c *DropScheduledQueryStatementContext)

	// EnterAlterScheduledQueryStatement is called when entering the alterScheduledQueryStatement production.
	EnterAlterScheduledQueryStatement(c *AlterScheduledQueryStatementContext)

	// EnterAlterScheduledQueryChange is called when entering the alterScheduledQueryChange production.
	EnterAlterScheduledQueryChange(c *AlterScheduledQueryChangeContext)

	// EnterScheduleSpec is called when entering the scheduleSpec production.
	EnterScheduleSpec(c *ScheduleSpecContext)

	// EnterExecutedAsSpec is called when entering the executedAsSpec production.
	EnterExecutedAsSpec(c *ExecutedAsSpecContext)

	// EnterDefinedAsSpec is called when entering the definedAsSpec production.
	EnterDefinedAsSpec(c *DefinedAsSpecContext)
	...
	// EnterCreateTablePartitionSpec is called when entering the createTablePartitionSpec production.
	EnterCreateTablePartitionSpec(c *CreateTablePartitionSpecContext)

	// EnterCreateTablePartitionColumnTypeSpec is called when entering the createTablePartitionColumnTypeSpec production.
	EnterCreateTablePartitionColumnTypeSpec(c *CreateTablePartitionColumnTypeSpecContext)

	// EnterCreateTablePartitionColumnSpec is called when entering the createTablePartitionColumnSpec production.
	EnterCreateTablePartitionColumnSpec(c *CreateTablePartitionColumnSpecContext)

	// EnterPartitionTransformSpec is called when entering the partitionTransformSpec production.
	EnterPartitionTransformSpec(c *PartitionTransformSpecContext)

	// EnterColumnNameTransformConstraint is called when entering the columnNameTransformConstraint production.
	EnterColumnNameTransformConstraint(c *ColumnNameTransformConstraintContext)

	// EnterPartitionTransformType is called when entering the partitionTransformType production.
	EnterPartitionTransformType(c *PartitionTransformTypeContext)

	// EnterTableBuckets is called when entering the tableBuckets production.
	EnterTableBuckets(c *TableBucketsContext)

	// EnterTableImplBuckets is called when entering the tableImplBuckets production.
	EnterTableImplBuckets(c *TableImplBucketsContext)
	...
	// EnterOrderSpecificationRewrite is called when entering the orderSpecificationRewrite production.
	EnterOrderSpecificationRewrite(c *OrderSpecificationRewriteContext)
	...
	// EnterPrecedencePlusExpressionOrDefault is called when entering the precedencePlusExpressionOrDefault production.
	EnterPrecedencePlusExpressionOrDefault(c *PrecedencePlusExpressionOrDefaultContext)
	...
	// EnterAbortCompactionStatement is called when entering the abortCompactionStatement production.
	EnterAbortCompactionStatement(c *AbortCompactionStatementContext)
	...
	// EnterCompactionId is called when entering the compactionId production.
	EnterCompactionId(c *CompactionIdContext)

	// EnterCompactionPool is called when entering the compactionPool production.
	EnterCompactionPool(c *CompactionPoolContext)

	// EnterCompactionType is called when entering the compactionType production.
	EnterCompactionType(c *CompactionTypeContext)

	// EnterCompactionStatus is called when entering the compactionStatus production.
	EnterCompactionStatus(c *CompactionStatusContext)
	...
	// EnterAlterDatabaseSuffixSetManagedLocation is called when entering the alterDatabaseSuffixSetManagedLocation production.
	EnterAlterDatabaseSuffixSetManagedLocation(c *AlterDatabaseSuffixSetManagedLocationContext)
	...
	// EnterCompactPool is called when entering the compactPool production.
	EnterCompactPool(c *CompactPoolContext)
	...
	// EnterAlterStatementSuffixSetPartSpec is called when entering the alterStatementSuffixSetPartSpec production.
	EnterAlterStatementSuffixSetPartSpec(c *AlterStatementSuffixSetPartSpecContext)

	// EnterAlterStatementSuffixExecute is called when entering the alterStatementSuffixExecute production.
	EnterAlterStatementSuffixExecute(c *AlterStatementSuffixExecuteContext)

	// EnterFileFormat is called when entering the fileFormat production.
	EnterFileFormat(c *FileFormatContext)

	// EnterAlterDataConnectorStatementSuffix is called when entering the alterDataConnectorStatementSuffix production.
	EnterAlterDataConnectorStatementSuffix(c *AlterDataConnectorStatementSuffixContext)

	// EnterAlterDataConnectorSuffixProperties is called when entering the alterDataConnectorSuffixProperties production.
	EnterAlterDataConnectorSuffixProperties(c *AlterDataConnectorSuffixPropertiesContext)

	// EnterAlterDataConnectorSuffixSetOwner is called when entering the alterDataConnectorSuffixSetOwner production.
	EnterAlterDataConnectorSuffixSetOwner(c *AlterDataConnectorSuffixSetOwnerContext)

	// EnterAlterDataConnectorSuffixSetUrl is called when entering the alterDataConnectorSuffixSetUrl production.
	EnterAlterDataConnectorSuffixSetUrl(c *AlterDataConnectorSuffixSetUrlContext)

	// EnterLikeTableOrFile is called when entering the likeTableOrFile production.
	EnterLikeTableOrFile(c *LikeTableOrFileContext)
	...
	// EnterCreateDataConnectorStatement is called when entering the createDataConnectorStatement production.
	EnterCreateDataConnectorStatement(c *CreateDataConnectorStatementContext)

	// EnterDataConnectorComment is called when entering the dataConnectorComment production.
	EnterDataConnectorComment(c *DataConnectorCommentContext)

	// EnterDataConnectorUrl is called when entering the dataConnectorUrl production.
	EnterDataConnectorUrl(c *DataConnectorUrlContext)

	// EnterDataConnectorType is called when entering the dataConnectorType production.
	EnterDataConnectorType(c *DataConnectorTypeContext)

	// EnterDcProperties is called when entering the dcProperties production.
	EnterDcProperties(c *DcPropertiesContext)

	// EnterDropDataConnectorStatement is called when entering the dropDataConnectorStatement production.
	EnterDropDataConnectorStatement(c *DropDataConnectorStatementContext)
	...
	// EnterAsOfClause is called when entering the asOfClause production.
	EnterAsOfClause(c *AsOfClauseContext)
	...
	// EnterValuesSource is called when entering the valuesSource production.
	EnterValuesSource(c *ValuesSourceContext)
	...
	// EnterFirstValueRowConstructor is called when entering the firstValueRowConstructor production.
	EnterFirstValueRowConstructor(c *FirstValueRowConstructorContext)
	...
	// EnterFirstExpressionsWithAlias is called when entering the firstExpressionsWithAlias production.
	EnterFirstExpressionsWithAlias(c *FirstExpressionsWithAliasContext)

	// EnterExpressionWithAlias is called when entering the expressionWithAlias production.
	EnterExpressionWithAlias(c *ExpressionWithAliasContext)
	...
	// EnterPrepareStmtParam is called when entering the prepareStmtParam production.
	EnterPrepareStmtParam(c *PrepareStmtParamContext)

	// EnterParameterIdx is called when entering the parameterIdx production.
	EnterParameterIdx(c *ParameterIdxContext)
	...
	// EnterPrecedenceFieldExpression is called when entering the precedenceFieldExpression production.
	EnterPrecedenceFieldExpression(c *PrecedenceFieldExpressionContext)
	...
	// EnterPrecedenceUnaryPrefixExpression is called when entering the precedenceUnaryPrefixExpression production.
	EnterPrecedenceUnaryPrefixExpression(c *PrecedenceUnaryPrefixExpressionContext)
	...
	// EnterPrecedenceBitwiseXorExpression is called when entering the precedenceBitwiseXorExpression production.
	EnterPrecedenceBitwiseXorExpression(c *PrecedenceBitwiseXorExpressionContext)
	...
	// EnterPrecedenceStarExpression is called when entering the precedenceStarExpression production.
	EnterPrecedenceStarExpression(c *PrecedenceStarExpressionContext)
	...
	// EnterPrecedencePlusExpression is called when entering the precedencePlusExpression production.
	EnterPrecedencePlusExpression(c *PrecedencePlusExpressionContext)
	...
	// EnterPrecedenceConcatenateExpression is called when entering the precedenceConcatenateExpression production.
	EnterPrecedenceConcatenateExpression(c *PrecedenceConcatenateExpressionContext)
	...
	// EnterPrecedenceAmpersandExpression is called when entering the precedenceAmpersandExpression production.
	EnterPrecedenceAmpersandExpression(c *PrecedenceAmpersandExpressionContext)
	...
	// EnterPrecedenceBitwiseOrExpression is called when entering the precedenceBitwiseOrExpression production.
	EnterPrecedenceBitwiseOrExpression(c *PrecedenceBitwiseOrExpressionContext)
	...
	// EnterPrecedenceSimilarExpression is called when entering the precedenceSimilarExpression production.
	EnterPrecedenceSimilarExpression(c *PrecedenceSimilarExpressionContext)

	// EnterPrecedenceSimilarExpressionMain is called when entering the precedenceSimilarExpressionMain production.
	EnterPrecedenceSimilarExpressionMain(c *PrecedenceSimilarExpressionMainContext)
	...
	// EnterPrecedenceSimilarExpressionQuantifierPredicate is called when entering the precedenceSimilarExpressionQuantifierPredicate production.
	EnterPrecedenceSimilarExpressionQuantifierPredicate(c *PrecedenceSimilarExpressionQuantifierPredicateContext)

	// EnterQuantifierType is called when entering the quantifierType production.
	EnterQuantifierType(c *QuantifierTypeContext)
	...
	// EnterPrecedenceEqualExpression is called when entering the precedenceEqualExpression production.
	EnterPrecedenceEqualExpression(c *PrecedenceEqualExpressionContext)

	// EnterIsCondition is called when entering the isCondition production.
	EnterIsCondition(c *IsConditionContext)

	// EnterPrecedenceUnarySuffixExpression is called when entering the precedenceUnarySuffixExpression production.
	EnterPrecedenceUnarySuffixExpression(c *PrecedenceUnarySuffixExpressionContext)
	...
	// EnterPrecedenceNotExpression is called when entering the precedenceNotExpression production.
	EnterPrecedenceNotExpression(c *PrecedenceNotExpressionContext)
	...
	// EnterPrecedenceAndExpression is called when entering the precedenceAndExpression production.
	EnterPrecedenceAndExpression(c *PrecedenceAndExpressionContext)
	...
	// EnterPrecedenceOrExpression is called when entering the precedenceOrExpression production.
	EnterPrecedenceOrExpression(c *PrecedenceOrExpressionContext)
	...
	// EnterPartitionSelectorSpec is called when entering the partitionSelectorSpec production.
	EnterPartitionSelectorSpec(c *PartitionSelectorSpecContext)

	// EnterPartitionSelectorVal is called when entering the partitionSelectorVal production.
	EnterPartitionSelectorVal(c *PartitionSelectorValContext)

	// EnterPartitionSelectorOperator is called when entering the partitionSelectorOperator production.
	EnterPartitionSelectorOperator(c *PartitionSelectorOperatorContext)

	// EnterSubQuerySelectorOperator is called when entering the subQuerySelectorOperator production.
	EnterSubQuerySelectorOperator(c *SubQuerySelectorOperatorContext)
	...
	// EnterExecuteParamList is called when entering the executeParamList production.
	EnterExecuteParamList(c *ExecuteParamListContext)
	...
	// ExitReplDbPolicy is called when exiting the replDbPolicy production.
	ExitReplDbPolicy(c *ReplDbPolicyContext)
	...
	// ExitReplTableLevelPolicy is called when exiting the replTableLevelPolicy production.
	ExitReplTableLevelPolicy(c *ReplTableLevelPolicyContext)
	...
	// ExitDbManagedLocation is called when exiting the dbManagedLocation production.
	ExitDbManagedLocation(c *DbManagedLocationContext)
	...
	// ExitDbConnectorName is called when exiting the dbConnectorName production.
	ExitDbConnectorName(c *DbConnectorNameContext)
	...
	// ExitDb_schema is called when exiting the db_schema production.
	ExitDb_schema(c *Db_schemaContext)

	// ExitShowStatement is called when exiting the showStatement production.
	ExitShowStatement(c *ShowStatementContext)

	// ExitShowTablesFilterExpr is called when exiting the showTablesFilterExpr production.
	ExitShowTablesFilterExpr(c *ShowTablesFilterExprContext)
	...
	// ExitReloadFunctionsStatement is called when exiting the reloadFunctionsStatement production.
	ExitReloadFunctionsStatement(c *ReloadFunctionsStatementContext)
	...
	// ExitViewOrganization is called when exiting the viewOrganization production.
	ExitViewOrganization(c *ViewOrganizationContext)

	// ExitViewClusterSpec is called when exiting the viewClusterSpec production.
	ExitViewClusterSpec(c *ViewClusterSpecContext)

	// ExitViewComplexSpec is called when exiting the viewComplexSpec production.
	ExitViewComplexSpec(c *ViewComplexSpecContext)

	// ExitViewDistSpec is called when exiting the viewDistSpec production.
	ExitViewDistSpec(c *ViewDistSpecContext)

	// ExitViewSortSpec is called when exiting the viewSortSpec production.
	ExitViewSortSpec(c *ViewSortSpecContext)
	...
	// ExitCreateScheduledQueryStatement is called when exiting the createScheduledQueryStatement production.
	ExitCreateScheduledQueryStatement(c *CreateScheduledQueryStatementContext)

	// ExitDropScheduledQueryStatement is called when exiting the dropScheduledQueryStatement production.
	ExitDropScheduledQueryStatement(c *DropScheduledQueryStatementContext)

	// ExitAlterScheduledQueryStatement is called when exiting the alterScheduledQueryStatement production.
	ExitAlterScheduledQueryStatement(c *AlterScheduledQueryStatementContext)

	// ExitAlterScheduledQueryChange is called when exiting the alterScheduledQueryChange production.
	ExitAlterScheduledQueryChange(c *AlterScheduledQueryChangeContext)

	// ExitScheduleSpec is called when exiting the scheduleSpec production.
	ExitScheduleSpec(c *ScheduleSpecContext)

	// ExitExecutedAsSpec is called when exiting the executedAsSpec production.
	ExitExecutedAsSpec(c *ExecutedAsSpecContext)

	// ExitDefinedAsSpec is called when exiting the definedAsSpec production.
	ExitDefinedAsSpec(c *DefinedAsSpecContext)
	...
	// ExitCreateTablePartitionSpec is called when exiting the createTablePartitionSpec production.
	ExitCreateTablePartitionSpec(c *CreateTablePartitionSpecContext)

	// ExitCreateTablePartitionColumnTypeSpec is called when exiting the createTablePartitionColumnTypeSpec production.
	ExitCreateTablePartitionColumnTypeSpec(c *CreateTablePartitionColumnTypeSpecContext)

	// ExitCreateTablePartitionColumnSpec is called when exiting the createTablePartitionColumnSpec production.
	ExitCreateTablePartitionColumnSpec(c *CreateTablePartitionColumnSpecContext)

	// ExitPartitionTransformSpec is called when exiting the partitionTransformSpec production.
	ExitPartitionTransformSpec(c *PartitionTransformSpecContext)

	// ExitColumnNameTransformConstraint is called when exiting the columnNameTransformConstraint production.
	ExitColumnNameTransformConstraint(c *ColumnNameTransformConstraintContext)

	// ExitPartitionTransformType is called when exiting the partitionTransformType production.
	ExitPartitionTransformType(c *PartitionTransformTypeContext)

	// ExitTableBuckets is called when exiting the tableBuckets production.
	ExitTableBuckets(c *TableBucketsContext)

	// ExitTableImplBuckets is called when exiting the tableImplBuckets production.
	ExitTableImplBuckets(c *TableImplBucketsContext)
	...
	// ExitOrderSpecificationRewrite is called when exiting the orderSpecificationRewrite production.
	ExitOrderSpecificationRewrite(c *OrderSpecificationRewriteContext)
	...
	// ExitPrecedencePlusExpressionOrDefault is called when exiting the precedencePlusExpressionOrDefault production.
	ExitPrecedencePlusExpressionOrDefault(c *PrecedencePlusExpressionOrDefaultContext)
	...
	// ExitAbortCompactionStatement is called when exiting the abortCompactionStatement production.
	ExitAbortCompactionStatement(c *AbortCompactionStatementContext)
	...
	// ExitCompactionId is called when exiting the compactionId production.
	ExitCompactionId(c *CompactionIdContext)

	// ExitCompactionPool is called when exiting the compactionPool production.
	ExitCompactionPool(c *CompactionPoolContext)

	// ExitCompactionType is called when exiting the compactionType production.
	ExitCompactionType(c *CompactionTypeContext)

	// ExitCompactionStatus is called when exiting the compactionStatus production.
	ExitCompactionStatus(c *CompactionStatusContext)
	...
	// ExitAlterDatabaseSuffixSetManagedLocation is called when exiting the alterDatabaseSuffixSetManagedLocation production.
	ExitAlterDatabaseSuffixSetManagedLocation(c *AlterDatabaseSuffixSetManagedLocationContext)
	...
	// ExitCompactPool is called when exiting the compactPool production.
	ExitCompactPool(c *CompactPoolContext)
	...
	// ExitAlterStatementSuffixSetPartSpec is called when exiting the alterStatementSuffixSetPartSpec production.
	ExitAlterStatementSuffixSetPartSpec(c *AlterStatementSuffixSetPartSpecContext)

	// ExitAlterStatementSuffixExecute is called when exiting the alterStatementSuffixExecute production.
	ExitAlterStatementSuffixExecute(c *AlterStatementSuffixExecuteContext)

	// ExitFileFormat is called when exiting the fileFormat production.
	ExitFileFormat(c *FileFormatContext)

	// ExitAlterDataConnectorStatementSuffix is called when exiting the alterDataConnectorStatementSuffix production.
	ExitAlterDataConnectorStatementSuffix(c *AlterDataConnectorStatementSuffixContext)

	// ExitAlterDataConnectorSuffixProperties is called when exiting the alterDataConnectorSuffixProperties production.
	ExitAlterDataConnectorSuffixProperties(c *AlterDataConnectorSuffixPropertiesContext)

	// ExitAlterDataConnectorSuffixSetOwner is called when exiting the alterDataConnectorSuffixSetOwner production.
	ExitAlterDataConnectorSuffixSetOwner(c *AlterDataConnectorSuffixSetOwnerContext)

	// ExitAlterDataConnectorSuffixSetUrl is called when exiting the alterDataConnectorSuffixSetUrl production.
	ExitAlterDataConnectorSuffixSetUrl(c *AlterDataConnectorSuffixSetUrlContext)

	// ExitLikeTableOrFile is called when exiting the likeTableOrFile production.
	ExitLikeTableOrFile(c *LikeTableOrFileContext)
	...
	// ExitCreateDataConnectorStatement is called when exiting the createDataConnectorStatement production.
	ExitCreateDataConnectorStatement(c *CreateDataConnectorStatementContext)

	// ExitDataConnectorComment is called when exiting the dataConnectorComment production.
	ExitDataConnectorComment(c *DataConnectorCommentContext)

	// ExitDataConnectorUrl is called when exiting the dataConnectorUrl production.
	ExitDataConnectorUrl(c *DataConnectorUrlContext)

	// ExitDataConnectorType is called when exiting the dataConnectorType production.
	ExitDataConnectorType(c *DataConnectorTypeContext)

	// ExitDcProperties is called when exiting the dcProperties production.
	ExitDcProperties(c *DcPropertiesContext)

	// ExitDropDataConnectorStatement is called when exiting the dropDataConnectorStatement production.
	ExitDropDataConnectorStatement(c *DropDataConnectorStatementContext)
	...
	// ExitAsOfClause is called when exiting the asOfClause production.
	ExitAsOfClause(c *AsOfClauseContext)
	...
	// ExitValuesSource is called when exiting the valuesSource production.
	ExitValuesSource(c *ValuesSourceContext)
	...
	// ExitFirstValueRowConstructor is called when exiting the firstValueRowConstructor production.
	ExitFirstValueRowConstructor(c *FirstValueRowConstructorContext)
	...
	// ExitFirstExpressionsWithAlias is called when exiting the firstExpressionsWithAlias production.
	ExitFirstExpressionsWithAlias(c *FirstExpressionsWithAliasContext)

	// ExitExpressionWithAlias is called when exiting the expressionWithAlias production.
	ExitExpressionWithAlias(c *ExpressionWithAliasContext)
	...
	// ExitPrepareStmtParam is called when exiting the prepareStmtParam production.
	ExitPrepareStmtParam(c *PrepareStmtParamContext)

	// ExitParameterIdx is called when exiting the parameterIdx production.
	ExitParameterIdx(c *ParameterIdxContext)
	...
	// ExitPrecedenceFieldExpression is called when exiting the precedenceFieldExpression production.
	ExitPrecedenceFieldExpression(c *PrecedenceFieldExpressionContext)
	...
	// ExitPrecedenceUnaryPrefixExpression is called when exiting the precedenceUnaryPrefixExpression production.
	ExitPrecedenceUnaryPrefixExpression(c *PrecedenceUnaryPrefixExpressionContext)
	...
	// ExitPrecedenceBitwiseXorExpression is called when exiting the precedenceBitwiseXorExpression production.
	ExitPrecedenceBitwiseXorExpression(c *PrecedenceBitwiseXorExpressionContext)
	...
	// ExitPrecedenceStarExpression is called when exiting the precedenceStarExpression production.
	ExitPrecedenceStarExpression(c *PrecedenceStarExpressionContext)
	...
	// ExitPrecedencePlusExpression is called when exiting the precedencePlusExpression production.
	ExitPrecedencePlusExpression(c *PrecedencePlusExpressionContext)
	...
	// ExitPrecedenceConcatenateExpression is called when exiting the precedenceConcatenateExpression production.
	ExitPrecedenceConcatenateExpression(c *PrecedenceConcatenateExpressionContext)
	...
	// ExitPrecedenceAmpersandExpression is called when exiting the precedenceAmpersandExpression production.
	ExitPrecedenceAmpersandExpression(c *PrecedenceAmpersandExpressionContext)
	...
	// ExitPrecedenceBitwiseOrExpression is called when exiting the precedenceBitwiseOrExpression production.
	ExitPrecedenceBitwiseOrExpression(c *PrecedenceBitwiseOrExpressionContext)
	...
	// ExitPrecedenceSimilarExpression is called when exiting the precedenceSimilarExpression production.
	ExitPrecedenceSimilarExpression(c *PrecedenceSimilarExpressionContext)

	// ExitPrecedenceSimilarExpressionMain is called when exiting the precedenceSimilarExpressionMain production.
	ExitPrecedenceSimilarExpressionMain(c *PrecedenceSimilarExpressionMainContext)
	...
	// ExitPrecedenceSimilarExpressionQuantifierPredicate is called when exiting the precedenceSimilarExpressionQuantifierPredicate production.
	ExitPrecedenceSimilarExpressionQuantifierPredicate(c *PrecedenceSimilarExpressionQuantifierPredicateContext)

	// ExitQuantifierType is called when exiting the quantifierType production.
	ExitQuantifierType(c *QuantifierTypeContext)
	...
	// ExitPrecedenceEqualExpression is called when exiting the precedenceEqualExpression production.
	ExitPrecedenceEqualExpression(c *PrecedenceEqualExpressionContext)

	// ExitIsCondition is called when exiting the isCondition production.
	ExitIsCondition(c *IsConditionContext)

	// ExitPrecedenceUnarySuffixExpression is called when exiting the precedenceUnarySuffixExpression production.
	ExitPrecedenceUnarySuffixExpression(c *PrecedenceUnarySuffixExpressionContext)
	...
	// ExitPrecedenceNotExpression is called when exiting the precedenceNotExpression production.
	ExitPrecedenceNotExpression(c *PrecedenceNotExpressionContext)
	...
	// ExitPrecedenceAndExpression is called when exiting the precedenceAndExpression production.
	ExitPrecedenceAndExpression(c *PrecedenceAndExpressionContext)
	...
	// ExitPrecedenceOrExpression is called when exiting the precedenceOrExpression production.
	ExitPrecedenceOrExpression(c *PrecedenceOrExpressionContext)
	...
	// ExitPartitionSelectorSpec is called when exiting the partitionSelectorSpec production.
	ExitPartitionSelectorSpec(c *PartitionSelectorSpecContext)

	// ExitPartitionSelectorVal is called when exiting the partitionSelectorVal production.
	ExitPartitionSelectorVal(c *PartitionSelectorValContext)

	// ExitPartitionSelectorOperator is called when exiting the partitionSelectorOperator production.
	ExitPartitionSelectorOperator(c *PartitionSelectorOperatorContext)

	// ExitSubQuerySelectorOperator is called when exiting the subQuerySelectorOperator production.
	ExitSubQuerySelectorOperator(c *SubQuerySelectorOperatorContext)
	...
	// ExitExecuteParamList is called when exiting the executeParamList production.
	ExitExecuteParamList(c *ExecuteParamListContext)
